...
import com.fitnessapps.workoutapps.BegginnerLevel.fragment.ExcerciseActivity.All_Day_Excercise.dayoneexcerciseFragment.all_excercise_classes.Day_one_push_up_class;
import com.fitnessapps.workoutapps.R;

public class Puch_up_fragment extends Fragment {
View dayone;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view= inflater.inflate(R.layout.fragment_puch_up_fragment, container, false);

        dayone=view.findViewById(R.id.day_one_pushup);
        dayone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Day_one_push_up_class dayoneAbdomial_class=new Day_one_push_up_class();
