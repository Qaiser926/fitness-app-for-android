...
public class High_plank_jack_ready_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_high_plank_jack_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(High_plank_jack_ready_togo.this,
                                        High_plank_jack_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        High_plank_jack_ready_togo.super.onBackPressed();
                        Intent intent=new Intent(High_plank_jack_ready_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
