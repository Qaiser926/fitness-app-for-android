...
public class Elevated_pike_pushup_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elevated_pike_pushup_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Elevated_pike_pushup_startExercise.this,
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Elevated_pike_pushup_startExercise.this,
                        Elevated_pike_pushup_rest.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Elevated_pike_pushup_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Elevated_pike_pushup_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
