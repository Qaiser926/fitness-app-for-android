...
public class BicycleCruches_StartExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bicycle_cruches_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BicycleCruches_StartExercise.this,
                        Backtwist_StartExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        BicycleCruches_StartExercise.super.onBackPressed();
                        Intent intent=new Intent(BicycleCruches_StartExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
