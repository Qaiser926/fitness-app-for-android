...
public class ReverseCraches_StartExercise extends AppCompatActivity {
   ...
   com.facebook.ads.InterstitialAd fbinterstitialads;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reverse_craches_start_exercise);
...
// Request an ad
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ReverseCraches_StartExercise.this,
                        CobraStrech_StartExercise.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ReverseCraches_StartExercise.this,
                        ReverseCraches_restActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void SquatExerciseDone() {
            ...
            public void onClick(View v) {
                ...
                if (admobInterstitialAd != null) {
                    admobInterstitialAd.show(ReverseCraches_StartExercise.this);
        ...
        AlertDialog.Builder alertbox = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ReverseCraches_StartExercise.super.onBackPressed();
                        Intent intent = new Intent(ReverseCraches_StartExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
