...
public class Side_lungeto_curtsy_lunkgeLeft_ready_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_side_lungeto_curtsy_lunkge_left_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Side_lungeto_curtsy_lunkgeLeft_ready_togo.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Side_lungeto_curtsy_lunkgeLeft_ready_togo.super.onBackPressed();
                        Intent intent=new Intent(Side_lungeto_curtsy_lunkgeLeft_ready_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
