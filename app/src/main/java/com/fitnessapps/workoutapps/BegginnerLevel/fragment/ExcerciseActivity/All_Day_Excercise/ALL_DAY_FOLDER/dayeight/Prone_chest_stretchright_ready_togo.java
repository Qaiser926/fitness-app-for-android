...
public class Prone_chest_stretchright_ready_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prone_chest_stretchright_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Prone_chest_stretchright_ready_togo.this,
                                        Prone_chest_stretchright_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Prone_chest_stretchright_ready_togo.super.onBackPressed();
                        Intent intent=new Intent(Prone_chest_stretchright_ready_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
