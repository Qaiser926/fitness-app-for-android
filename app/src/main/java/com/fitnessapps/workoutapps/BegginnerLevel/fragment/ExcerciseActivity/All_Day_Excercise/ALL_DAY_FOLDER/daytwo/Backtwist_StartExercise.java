...
public class Backtwist_StartExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_backtwist_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Excercise_fragment squats_fragment = new Excercise_fragment();
                FragmentManager fm = getSupportFragmentManager();
                FragmentTransaction transaction = fm.beginTransaction();
                transaction.replace(R.id.main_dietcontainer, squats_fragment);
                transaction.commit();
            }
        });
    }
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Backtwist_StartExercise.this,
                        Backtwist_restActivity.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Backtwist_StartExercise.super.onBackPressed();
                        Intent intent=new Intent(Backtwist_StartExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
