...
public class DayOne_squat_startexercise_activity extends AppCompatActivity {
    Button done;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day_one_squat);
...
// Request an ad
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(DayOne_squat_startexercise_activity.this,StartExercise_mountainclimber.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(DayOne_squat_startexercise_activity.this,Dayone_squat_rest_Activity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        DayOne_squat_startexercise_activity.super.onBackPressed();
                        Intent intent=new Intent(DayOne_squat_startexercise_activity.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
                    }
