...
public class Bike_pushup_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bike_pushup_start_exercise);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Bike_pushup_startExercise.this,
                        Bike_pushup_rest.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Bike_pushup_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Bike_pushup_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
