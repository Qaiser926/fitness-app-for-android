...
public class Cocoons_startExercise extends AppCompatActivity {
...
InterstitialAd fbinterstitialads;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cocoons_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cocoons_startExercise.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Cocoons_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Cocoons_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
