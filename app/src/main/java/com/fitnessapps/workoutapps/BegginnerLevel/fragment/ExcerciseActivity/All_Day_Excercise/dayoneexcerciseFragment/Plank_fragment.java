...
import com.fitnessapps.workoutapps.BegginnerLevel.fragment.ExcerciseActivity.All_Day_Excercise.dayoneexcerciseFragment.all_excercise_classes.Day_one_plank_class;
import com.fitnessapps.workoutapps.R;

public class Plank_fragment extends Fragment {
View dayone;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_plank_fragment, container, false);

        dayone=view.findViewById(R.id.day_one_plank);
        dayone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Day_one_plank_class dayoneAbdomial_class=new Day_one_plank_class();
