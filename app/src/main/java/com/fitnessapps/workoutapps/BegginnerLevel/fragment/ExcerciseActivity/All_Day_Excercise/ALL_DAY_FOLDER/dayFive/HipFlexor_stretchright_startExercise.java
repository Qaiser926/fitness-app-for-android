...
public class HipFlexor_stretchright_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hip_flexor_stretchright_start_exercise);
...
// Request an ad
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HipFlexor_stretchright_startExercise.this,
                        HipFlexor_stretchLeft_startExercise.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HipFlexor_stretchright_startExercise.this,
                        HipFlexor_stretchright_rest.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        HipFlexor_stretchright_startExercise.super.onBackPressed();
                        Intent intent=new Intent(HipFlexor_stretchright_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
