...
public class DayFiveExcercise extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_day_five_excercise, container, false);

        circular_pro = view.findViewById(R.id.btnone_progressbar);
        dayfive = view.findViewById(R.id.diet_dayfive);
        status = view.findViewById(R.id.btnOne_progressstatus);
        dayfive.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getActivity(), DayFive.class);
