...
public class DayTenExcercise extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_day_ten_excercise, container, false);
        return view;
    }
}
//        circular_pro = view.findViewById(R.id.btnone_progressbar);
//        dayone = view.findViewById(R.id.diet_dayten);
