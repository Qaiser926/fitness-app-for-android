...
public class StartExercise_abdominalcrunches extends AppCompatActivity {
    Button done;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_exercise_abdominalcrunches);
...
// Request an ad
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(StartExercise_abdominalcrunches.this,
                        DayOne_squat_startexercise_activity.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(StartExercise_abdominalcrunches.this,
                        AbdominalCrunches_restActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        StartExercise_abdominalcrunches.super.onBackPressed();
                        Intent intent=new Intent(StartExercise_abdominalcrunches.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
