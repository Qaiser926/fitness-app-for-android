...
public class Decline_wide_pushup_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_decline_wide_pushup_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Decline_wide_pushup_startExercise.this,
                        Crosskness_tricep_startExercise.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Decline_wide_pushup_startExercise.this,
                        Decline_wide_pushup_startExercise.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void SquatExerciseDone() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Decline_wide_pushup_startExercise.this,
                        Decline_wide_pushup_rest.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Decline_wide_pushup_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Decline_wide_pushup_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
