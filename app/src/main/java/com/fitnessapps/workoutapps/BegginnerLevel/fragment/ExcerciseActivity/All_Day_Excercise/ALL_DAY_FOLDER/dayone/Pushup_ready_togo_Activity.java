...
public class Pushup_ready_togo_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pushup_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Pushup_ready_togo_Activity.this,StartExercise_pushup.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Pushup_ready_togo_Activity.super.onBackPressed();
                        Intent intent=new Intent(Pushup_ready_togo_Activity.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
