...
public class DaySevenExcercise extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_day_seven_excercise, container, false);

        circular_pro = view.findViewById(R.id.btnone_progressbar);
        dayone = view.findViewById(R.id.diet_dayseven);
        status = view.findViewById(R.id.btnOne_progressstatus);
        dayone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getActivity(), DaySeven.class);
