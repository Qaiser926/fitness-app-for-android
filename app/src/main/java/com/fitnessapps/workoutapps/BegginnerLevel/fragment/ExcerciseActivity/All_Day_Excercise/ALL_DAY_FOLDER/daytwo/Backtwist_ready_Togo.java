...
public class Backtwist_ready_Togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_backtwist_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Backtwist_ready_Togo.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Backtwist_ready_Togo.super.onBackPressed();
                        Intent intent=new Intent(Backtwist_ready_Togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
