...
public class Prone_chest_stretchLeft_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prone_chest_stretch_left_start_exercise);
...
// Request an ad
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Prone_chest_stretchLeft_startExercise.this,
                        Flutter_kick_startExercise.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Prone_chest_stretchLeft_startExercise.this,
                        Prone_chest_stretchLeft_rest.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Prone_chest_stretchLeft_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Prone_chest_stretchLeft_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
