...
public class Iren_manpose_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iren_manpose_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Iren_manpose_startExercise.this,
                        Incline_pushup_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Iren_manpose_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Iren_manpose_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
