...
public class Dynamic_hip_flexor_stretch_left_ready_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dynamic_hip_flexor_stretch_left_ready_togo2);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Dynamic_hip_flexor_stretch_left_ready_togo.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Dynamic_hip_flexor_stretch_left_ready_togo.super.onBackPressed();
                        Intent intent=new Intent(Dynamic_hip_flexor_stretch_left_ready_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
