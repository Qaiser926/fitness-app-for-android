...
public class High_steeping_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_high_steeping_start_exercise);
...
//                Intent intent = new Intent(High_steeping_startExercise.this,
//                        .class);
...
//    }
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(High_steeping_startExercise.this,
                        Hip_flexorLeft_startExercixe.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        High_steeping_startExercise.super.onBackPressed();
                        Intent intent=new Intent(High_steeping_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
