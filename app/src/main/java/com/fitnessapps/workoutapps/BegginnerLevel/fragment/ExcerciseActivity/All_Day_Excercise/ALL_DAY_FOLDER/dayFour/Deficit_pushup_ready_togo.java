...
public class Deficit_pushup_ready_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deficit_pushup_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Deficit_pushup_ready_togo.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Deficit_pushup_ready_togo.super.onBackPressed();
                        Intent intent=new Intent(Deficit_pushup_ready_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
