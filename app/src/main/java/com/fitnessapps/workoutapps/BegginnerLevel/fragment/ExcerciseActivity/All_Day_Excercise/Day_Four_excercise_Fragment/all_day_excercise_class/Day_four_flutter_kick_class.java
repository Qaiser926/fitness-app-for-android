...
public class Day_four_flutter_kick_class extends DialogFragment {
    TextView txtclose;
    Button nextbtn;
    Dialog dialog;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view= inflater.inflate(R.layout.day_four_flutter_kick_layout,container,false);

        // ab yaha par jo feature me add karna chahta ho o yaha par add karo ga.
        txtclose=view.findViewById(R.id.flutterkick_finish);
