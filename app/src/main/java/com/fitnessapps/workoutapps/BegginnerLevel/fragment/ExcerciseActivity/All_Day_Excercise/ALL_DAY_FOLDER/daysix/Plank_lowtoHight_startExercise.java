...
public class Plank_lowtoHight_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plank_lowto_hight_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Plank_lowtoHight_startExercise.this,
                        Oblique_twist_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Plank_lowtoHight_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Plank_lowtoHight_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
