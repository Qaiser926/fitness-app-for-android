...
public class Plank_StartExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plank_start_exercise);
...
//                transaction.commit();
                Intent intent=new Intent(Plank_StartExercise.this,Plank_rest_Activity.class);
...
//        transaction.commit();
    ...
    public void mountainclimber_previousbtn(View view) {
        Intent intent=new Intent(Plank_StartExercise.this,StartExercise_pushup.class);
        startActivity(intent);
        finish();
    }
    ...
    public void onStop() {
        super.onStop();
        SharedPreferences prefs = Plank_StartExercise.this.getSharedPreferences("Prefs",MODE_PRIVATE);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Plank_StartExercise.super.onBackPressed();
                        Intent intent=new Intent(Plank_StartExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
                        mcountdowntimer.cancel();
