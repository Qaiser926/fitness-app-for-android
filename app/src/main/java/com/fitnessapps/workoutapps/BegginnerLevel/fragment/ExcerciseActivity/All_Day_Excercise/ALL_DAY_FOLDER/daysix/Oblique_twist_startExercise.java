...
public class Oblique_twist_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oblique_twist_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Oblique_twist_startExercise.this,
                        Modiefied_burpee_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Oblique_twist_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Oblique_twist_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
