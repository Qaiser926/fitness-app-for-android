...
public class Box_glute_stretchright_read_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_box_glute_stretchright_read_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Box_glute_stretchright_read_togo.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Box_glute_stretchright_read_togo.super.onBackPressed();
                        Intent intent=new Intent(Box_glute_stretchright_read_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
