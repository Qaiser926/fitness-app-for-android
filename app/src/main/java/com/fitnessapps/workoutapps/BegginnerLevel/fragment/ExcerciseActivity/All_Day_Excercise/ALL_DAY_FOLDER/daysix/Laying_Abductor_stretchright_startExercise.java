...
public class Laying_Abductor_stretchright_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laying_abductor_stretchright_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Laying_Abductor_stretchright_startExercise.this,
                        Laying_Abductor_stretchleft_startExercise.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Laying_Abductor_stretchright_startExercise.this,
                        Laying_Abductor_stretchright_rest.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Laying_Abductor_stretchright_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Laying_Abductor_stretchright_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
