...
public class Box_glute_stretchright_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_box_glute_stretchright_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Box_glute_stretchright_startExercise.this,
                        Box_glute_stretchLeft_startExercise.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Box_glute_stretchright_startExercise.this,
                        Box_glute_stretchright_rest.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void SquatExerciseDone() {
            ...
            public void onClick(View v) {
                ...
                if (admobInterstitialAd != null) {
                    admobInterstitialAd.show(Box_glute_stretchright_startExercise.this);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Box_glute_stretchright_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Box_glute_stretchright_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
