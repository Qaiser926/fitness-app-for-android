...
public class Bulgarian_split_squat_jump_left_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bulgarian_split_squat_jump_left_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Bulgarian_split_squat_jump_left_startExercise.this,
                        Box_glute_stretchright_startExercise.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Bulgarian_split_squat_jump_left_startExercise.this,
                        Bulgarian_split_squat_jump_left_rest.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Bulgarian_split_squat_jump_left_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Bulgarian_split_squat_jump_left_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
