...
public class Russian_Twist_ready_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_russian_twist_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Russian_Twist_ready_togo.this,
                                        Russian_Twist_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Russian_Twist_ready_togo.super.onBackPressed();
                        Intent intent=new Intent(Russian_Twist_ready_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
