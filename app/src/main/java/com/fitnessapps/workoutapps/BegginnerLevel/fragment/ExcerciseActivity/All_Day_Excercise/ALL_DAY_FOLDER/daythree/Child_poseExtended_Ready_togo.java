...
public class Child_poseExtended_Ready_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_child_pose_extended_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Child_poseExtended_Ready_togo.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Child_poseExtended_Ready_togo.super.onBackPressed();
                        Intent intent=new Intent(Child_poseExtended_Ready_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
