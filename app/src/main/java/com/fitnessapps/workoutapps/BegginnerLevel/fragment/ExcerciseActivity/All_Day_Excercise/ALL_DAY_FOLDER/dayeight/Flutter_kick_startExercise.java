...
public class Flutter_kick_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flutter_kick_start_exercise2);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Flutter_kick_startExercise.this,
                        Bike_pushup_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Flutter_kick_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Flutter_kick_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
