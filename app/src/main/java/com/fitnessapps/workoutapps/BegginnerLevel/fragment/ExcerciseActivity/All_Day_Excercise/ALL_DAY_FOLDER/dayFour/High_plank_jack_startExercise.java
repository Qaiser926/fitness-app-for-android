...
public class High_plank_jack_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_high_plank_jack_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(High_plank_jack_startExercise.this,
                        High_kneeTap_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        High_plank_jack_startExercise.super.onBackPressed();
                        Intent intent=new Intent(High_plank_jack_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
