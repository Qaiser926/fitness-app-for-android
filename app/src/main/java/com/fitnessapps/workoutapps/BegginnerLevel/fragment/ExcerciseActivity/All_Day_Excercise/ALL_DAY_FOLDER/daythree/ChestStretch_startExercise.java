...
public class ChestStretch_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chest_stretch_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChestStretch_startExercise.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ChestStretch_startExercise.super.onBackPressed();
                        Intent intent=new Intent(ChestStretch_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
