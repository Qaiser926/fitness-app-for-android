...
public class DayoneExcercise extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_dayone_excercise, container, false);

        dayonebtn=view.findViewById(R.id.exercise_dayone);
...
//        gotoDayExcercise();
        ...
        dayone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(getContext(), DayOne.class);
