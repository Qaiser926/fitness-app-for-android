...
public class Dyaone_squat_readytogo_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dyaone_squat_readytogo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Dyaone_squat_readytogo_activity.this,DayOne_squat_startexercise_activity.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Dyaone_squat_readytogo_activity.super.onBackPressed();
                        Intent intent=new Intent(Dyaone_squat_readytogo_activity.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
