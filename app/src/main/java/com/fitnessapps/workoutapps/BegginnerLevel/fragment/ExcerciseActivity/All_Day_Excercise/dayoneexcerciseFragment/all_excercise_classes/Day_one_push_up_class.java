...
public class Day_one_push_up_class extends DialogFragment {
    TextView txtclose;
    Button nextbtn;
    Dialog dialog;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view= inflater.inflate(R.layout.day_one_pushup_layout,container,false);

        // ab yaha par jo feature me add karna chahta ho o yaha par add karo ga.
        txtclose=view.findViewById(R.id.push_up_finish);
