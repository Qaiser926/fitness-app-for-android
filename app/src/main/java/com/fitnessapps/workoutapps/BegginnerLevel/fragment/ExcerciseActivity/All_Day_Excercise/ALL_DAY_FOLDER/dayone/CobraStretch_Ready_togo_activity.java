...
public class CobraStretch_Ready_togo_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cobra_stretch_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(CobraStretch_Ready_togo_activity.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        CobraStretch_Ready_togo_activity.super.onBackPressed();
                        Intent intent=new Intent(CobraStretch_Ready_togo_activity.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
