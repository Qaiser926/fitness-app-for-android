...
public class Jumping_jack_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jumping_jack_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Jumping_jack_startExercise.this,
                        IrenMan_startExercise.class);
    ...
    private void SquatExerciseDone() {
            ...
            public void onClick(View v) {
                ...
                if (admobInterstitialAd != null) {
                    admobInterstitialAd.show(Jumping_jack_startExercise.this);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Jumping_jack_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Jumping_jack_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
