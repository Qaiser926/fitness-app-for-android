...
public class Dynamic_hip_flexor_stretch_right_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dynamic_hip_flexor_stretch_right_start_exercise2);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Dynamic_hip_flexor_stretch_right_startExercise.this,
                        Dynamic_hip_flexor_stretch_left_startExercise.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Dynamic_hip_flexor_stretch_right_startExercise.this,
                        Dynamic_hip_flexor_stretch_right_rest.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Dynamic_hip_flexor_stretch_right_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Dynamic_hip_flexor_stretch_right_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
