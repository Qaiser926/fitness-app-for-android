...
public class Side_lungeto_curtsy_lunkgeLeft_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_side_lungeto_curtsy_lunkge_left_start_exercise);
...
fbInterstitial_ads();
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Side_lungeto_curtsy_lunkgeLeft_startExercise.this,
                        Dynamic_hip_flexor_stretch_right_startExercise.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Side_lungeto_curtsy_lunkgeLeft_startExercise.this,
                        Side_lungeto_curtsy_lunkgeLeft_reset.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Side_lungeto_curtsy_lunkgeLeft_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Side_lungeto_curtsy_lunkgeLeft_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
