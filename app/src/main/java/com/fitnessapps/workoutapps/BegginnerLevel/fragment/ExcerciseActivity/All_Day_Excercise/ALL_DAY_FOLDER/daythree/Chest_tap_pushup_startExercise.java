...
public class Chest_tap_pushup_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chest_tap_pushup_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chest_tap_pushup_startExercise.this,
                        ChestStretch_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Chest_tap_pushup_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Chest_tap_pushup_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
