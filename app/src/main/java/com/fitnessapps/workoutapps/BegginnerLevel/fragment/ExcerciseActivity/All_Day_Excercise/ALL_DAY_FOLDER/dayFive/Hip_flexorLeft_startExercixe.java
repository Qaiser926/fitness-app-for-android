...
public class Hip_flexorLeft_startExercixe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hip_flexor_left_start_exercixe);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Hip_flexorLeft_startExercixe.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Hip_flexorLeft_startExercixe.super.onBackPressed();
                        Intent intent=new Intent(Hip_flexorLeft_startExercixe.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
