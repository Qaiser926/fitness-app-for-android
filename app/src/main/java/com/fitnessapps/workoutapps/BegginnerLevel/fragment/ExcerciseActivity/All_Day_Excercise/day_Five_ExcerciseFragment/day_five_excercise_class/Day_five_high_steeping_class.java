...
public class Day_five_high_steeping_class extends DialogFragment {
    TextView camalfinish;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.day_five_high_steeping,container,false);
        camalfinish=view.findViewById(R.id.highsteeping_finish);
