...
public class AbdominalCrunches_restActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abdominal_crunches_rest);
...
//                Toast.makeText(DayOne_RestActivity.this, "finish Succesful", Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(AbdominalCrunches_restActivity.this,Pushup_ready_togo_Activity.class);
                startActivity(intent);
                finish();
            }
        }.start();
...
//        mButtonstartpause.setVisibility(View.VISIBLE);
    ...
    public void mButtonSet(){
        mButonset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (input.length()==0){
                    Toast.makeText(AbdominalCrunches_restActivity.this, "Field can;t be empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                long millisInput=Long.parseLong(input)*60000;
                if (millisInput==0){
                    Toast.makeText(AbdominalCrunches_restActivity.this, "Please enter a positive number", Toast.LENGTH_SHORT).show();
                    return;
                }
                settime(millisInput);
    ...
    public void onStop() {
        super.onStop();
        SharedPreferences prefs= AbdominalCrunches_restActivity.this.getSharedPreferences("Prefs", Context.MODE_PRIVATE);
    ...
    public void onStart() {
        super.onStart();
        SharedPreferences prefs= AbdominalCrunches_restActivity.this.getSharedPreferences("prefs",MODE_PRIVATE);
...
//                Toast.makeText(DayOne_RestActivity.this, "next bton work seccessful", Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(AbdominalCrunches_restActivity.this,
                        Pushup_ready_togo_Activity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        AbdominalCrunches_restActivity.super.onBackPressed();
                        Intent intent=new Intent(AbdominalCrunches_restActivity.this,
                                MainActivity.class);
                        startActivity(intent);
                        mcountdowntimer.cancel();
