...
public class Tricept_curl_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tricept_curl_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tricept_curl_startExercise.this,
                        Side_plank_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Tricept_curl_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Tricept_curl_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
