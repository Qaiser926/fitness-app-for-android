...
public class Squate_kick_ready_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_squate_kick_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Squate_kick_ready_togo.this,
                                        Squate_kick_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Squate_kick_ready_togo.super.onBackPressed();
                        Intent intent=new Intent(Squate_kick_ready_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
