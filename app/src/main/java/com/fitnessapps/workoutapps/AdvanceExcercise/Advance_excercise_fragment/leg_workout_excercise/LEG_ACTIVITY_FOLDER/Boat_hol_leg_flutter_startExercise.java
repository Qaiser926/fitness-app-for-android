...
public class Boat_hol_leg_flutter_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boat_hol_leg_flutter_start_exercise);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Boat_hol_leg_flutter_startExercise.this,
                        Boat_hol_leg_flutter_rest_leg.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Boat_hol_leg_flutter_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Boat_hol_leg_flutter_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
