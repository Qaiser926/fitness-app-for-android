...
public class Brige_startExercise extends AppCompatActivity {
    Button done;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brige_start_exercise);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Brige_startExercise.this,
                        Brige_rest.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Brige_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Brige_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
