...
public class Chest_Stretch_startExercise_chest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chest_stretch_start_exercise_chest);
...
// Request an ad
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chest_Stretch_startExercise_chest.this,
                        Brige_startExercise.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chest_Stretch_startExercise_chest.this,
                        Chest_Stretch_rest_chest.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Chest_Stretch_startExercise_chest.super.onBackPressed();
                        Intent intent=new Intent(Chest_Stretch_startExercise_chest.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
