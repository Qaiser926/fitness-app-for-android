...
public class Squate_kick_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_squate_kick_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Squate_kick_startExercise.this,
                        Squate_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Squate_kick_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Squate_kick_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
