...
public class Jumping_jack_ready_togo_shoulder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jumping_jack_ready_togo_shoulder);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Jumping_jack_ready_togo_shoulder.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Jumping_jack_ready_togo_shoulder.super.onBackPressed();
                        Intent intent=new Intent(Jumping_jack_ready_togo_shoulder.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
