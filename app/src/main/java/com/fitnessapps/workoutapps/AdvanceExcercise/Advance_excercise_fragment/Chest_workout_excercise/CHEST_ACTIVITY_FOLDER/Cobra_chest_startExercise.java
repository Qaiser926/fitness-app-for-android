...
public class Cobra_chest_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cobra_chest_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cobra_chest_startExercise.this,
                        Chinup_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Cobra_chest_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Cobra_chest_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
