...
public class Cross_knee_tricept_ready_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cross_knee_tricept_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Cross_knee_tricept_ready_togo.this,
                                        Cross_knee_tricept_startExercise_shoulder.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Cross_knee_tricept_ready_togo.super.onBackPressed();
                        Intent intent=new Intent(Cross_knee_tricept_ready_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
