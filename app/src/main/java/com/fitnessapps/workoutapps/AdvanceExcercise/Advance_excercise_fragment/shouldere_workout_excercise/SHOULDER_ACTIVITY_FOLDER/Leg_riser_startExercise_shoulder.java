...
public class Leg_riser_startExercise_shoulder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leg_riser_start_exercise_shoulder);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Leg_riser_startExercise_shoulder.this,
                        Jumping_jack_startExercise_shoulder.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Leg_riser_startExercise_shoulder.super.onBackPressed();
                        Intent intent=new Intent(Leg_riser_startExercise_shoulder.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
