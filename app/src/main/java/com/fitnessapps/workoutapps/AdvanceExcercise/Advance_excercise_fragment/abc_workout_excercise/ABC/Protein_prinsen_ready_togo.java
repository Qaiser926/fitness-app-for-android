...
public class Protein_prinsen_ready_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_protein_prinsen_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Protein_prinsen_ready_togo.this,
                                        Protein_prinsen_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Protein_prinsen_ready_togo.super.onBackPressed();
                        Intent intent=new Intent(Protein_prinsen_ready_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
