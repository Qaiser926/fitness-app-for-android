...
public class Butt_kick_startExercise_leg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_butt_kick_start_exercise_leg);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Butt_kick_startExercise_leg.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Butt_kick_startExercise_leg.super.onBackPressed();
                        Intent intent=new Intent(Butt_kick_startExercise_leg.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
