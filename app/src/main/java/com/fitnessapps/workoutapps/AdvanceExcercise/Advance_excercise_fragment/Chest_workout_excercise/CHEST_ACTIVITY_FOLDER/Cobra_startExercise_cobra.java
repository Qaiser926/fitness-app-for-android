...
public class Cobra_startExercise_cobra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cobra_start_exercise_cobra);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cobra_startExercise_cobra.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Cobra_startExercise_cobra.super.onBackPressed();
                        Intent intent=new Intent(Cobra_startExercise_cobra.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
