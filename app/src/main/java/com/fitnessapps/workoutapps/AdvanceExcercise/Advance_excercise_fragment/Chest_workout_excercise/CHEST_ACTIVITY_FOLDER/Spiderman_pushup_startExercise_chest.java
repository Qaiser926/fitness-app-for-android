...
public class Spiderman_pushup_startExercise_chest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spiderman_pushup_start_exercise_chest);
...
// Request an ad
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Spiderman_pushup_startExercise_chest.this,
                        Cross_kneetricep_extension_startExercise_chest.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Spiderman_pushup_startExercise_chest.this,
                        Spiderman_pushup_rest_chest.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Spiderman_pushup_startExercise_chest.super.onBackPressed();
                        Intent intent=new Intent(Spiderman_pushup_startExercise_chest.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
