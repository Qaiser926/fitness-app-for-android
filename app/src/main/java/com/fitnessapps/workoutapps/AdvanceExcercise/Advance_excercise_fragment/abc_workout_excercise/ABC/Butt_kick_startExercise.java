...
public class Butt_kick_startExercise extends AppCompatActivity {

    private static final long START_TIME_IN_MILLIS=350000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_butt_kick_start_exercise);
...
//                transaction.commit();
                Intent intent=new Intent(Butt_kick_startExercise.this,
                        Butt_kick_rest.class);
    ...
    public void mountainclimber_skipbtn(View view) {
        Intent intent=new Intent(Butt_kick_startExercise.this,Butt_kick_rest.class);
        startActivity(intent);
        finish();
    }
    public void mountainclimber_previousbtn(View view) {
        Intent intent=new Intent(Butt_kick_startExercise.this, Boat_bold_beg_flutter_ready_togo.class);
        startActivity(intent);
        finish();
    }
    ...
    public void onStop() {
        super.onStop();
        SharedPreferences prefs = Butt_kick_startExercise.this.getSharedPreferences("Prefs",MODE_PRIVATE);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Butt_kick_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Butt_kick_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
