...
public class Step_upon_chair_ready_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_step_upon_chair_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Step_upon_chair_ready_togo.this,
                                        Step_upon_chair_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Step_upon_chair_ready_togo.super.onBackPressed();
                        Intent intent=new Intent(Step_upon_chair_ready_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
