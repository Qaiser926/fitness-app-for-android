...
public class Side_plank_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_side_plank_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Side_plank_startExercise.this,
                        Leg_riser_startExercise_shoulder.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Side_plank_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Side_plank_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
