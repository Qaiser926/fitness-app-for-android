...
public class Protein_prinsen_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_protein_prinsen_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Protein_prinsen_startExercise.this,
                        Man_doing_rop_Exercise_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Protein_prinsen_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Protein_prinsen_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
