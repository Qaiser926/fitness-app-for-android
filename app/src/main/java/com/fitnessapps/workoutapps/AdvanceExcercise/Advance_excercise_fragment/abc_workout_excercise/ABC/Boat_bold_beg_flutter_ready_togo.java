...
public class Boat_bold_beg_flutter_ready_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boat_bold_beg_flutter_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Boat_bold_beg_flutter_ready_togo.this,
                                        Boat_bold_beg_flutter_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Boat_bold_beg_flutter_ready_togo.super.onBackPressed();
                        Intent intent=new Intent(Boat_bold_beg_flutter_ready_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
