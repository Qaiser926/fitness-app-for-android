...
public class Chest_tap_pushup_startExercise_cheste extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chest_tap_pushup_start_exercise_cheste);
...
// Request an ad
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chest_tap_pushup_startExercise_cheste.this,
                        Chest_Stretch_startExercise_chest.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chest_tap_pushup_startExercise_cheste.this,
                        Chest_tap_pushup_rest_chest.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Chest_tap_pushup_startExercise_cheste.super.onBackPressed();
                        Intent intent=new Intent(Chest_tap_pushup_startExercise_cheste.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
