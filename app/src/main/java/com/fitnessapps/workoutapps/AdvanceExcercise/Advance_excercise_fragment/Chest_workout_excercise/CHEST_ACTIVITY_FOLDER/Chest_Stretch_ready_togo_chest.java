...
public class Chest_Stretch_ready_togo_chest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chest_stretch_ready_togo_chest);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Chest_Stretch_ready_togo_chest.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Chest_Stretch_ready_togo_chest.super.onBackPressed();
                        Intent intent=new Intent(Chest_Stretch_ready_togo_chest.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
