...
public class Side_hip_abduction_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_side_hip_abduction_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Side_hip_abduction_startExercise.this,
                        Lunge_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Side_hip_abduction_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Side_hip_abduction_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
