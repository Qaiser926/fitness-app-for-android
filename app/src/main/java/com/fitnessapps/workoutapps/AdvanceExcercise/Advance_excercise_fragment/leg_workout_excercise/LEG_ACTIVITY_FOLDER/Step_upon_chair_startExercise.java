...
public class Step_upon_chair_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_step_upon_chair_start_exercise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Step_upon_chair_startExercise.this,
                        Squat_kick_startExercise_leg.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Step_upon_chair_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Step_upon_chair_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
