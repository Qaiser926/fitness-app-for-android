...
public class Cobra_chest_ready_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cobra_chest_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Cobra_chest_ready_togo.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Cobra_chest_ready_togo.super.onBackPressed();
                        Intent intent=new Intent(Cobra_chest_ready_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
