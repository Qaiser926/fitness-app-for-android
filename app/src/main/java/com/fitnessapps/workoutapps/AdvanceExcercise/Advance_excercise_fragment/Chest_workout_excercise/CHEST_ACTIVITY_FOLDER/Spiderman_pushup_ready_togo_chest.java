...
public class Spiderman_pushup_ready_togo_chest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spiderman_pushup_ready_togo_chest);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Spiderman_pushup_ready_togo_chest.this,
                                        Spiderman_pushup_startExercise_chest.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Spiderman_pushup_ready_togo_chest.super.onBackPressed();
                        Intent intent=new Intent(Spiderman_pushup_ready_togo_chest.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
