...
public class Squat_kick_startExercise_leg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_squat_kick_start_exercise_leg);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Squat_kick_startExercise_leg.this,
                        Side_hip_abduction_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Squat_kick_startExercise_leg.super.onBackPressed();
                        Intent intent=new Intent(Squat_kick_startExercise_leg.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
