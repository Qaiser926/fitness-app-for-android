...
public class Burpee_pushup_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_burpee_pushup_start_exercise2);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Burpee_pushup_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Burpee_pushup_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
