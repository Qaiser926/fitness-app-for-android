...
public class Cross_knee_tricept_startExercise_shoulder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cross_knee_tricept_start_exercise_shoulder);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cross_knee_tricept_startExercise_shoulder.this,
                        Cross_knee_tricept_rest_shoulder.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Cross_knee_tricept_startExercise_shoulder.super.onBackPressed();
                        Intent intent=new Intent(Cross_knee_tricept_startExercise_shoulder.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
