...
public class Boat_hol_leg_flutter_ready_togo_leg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boat_hol_leg_flutter_ready_togo_leg);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Boat_hol_leg_flutter_ready_togo_leg.this,
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Boat_hol_leg_flutter_ready_togo_leg.super.onBackPressed();
                        Intent intent=new Intent(Boat_hol_leg_flutter_ready_togo_leg.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
