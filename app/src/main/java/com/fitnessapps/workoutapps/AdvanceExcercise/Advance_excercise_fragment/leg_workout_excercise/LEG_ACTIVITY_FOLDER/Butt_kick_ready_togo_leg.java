...
public class Butt_kick_ready_togo_leg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_butt_kick_ready_togo_leg);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Butt_kick_ready_togo_leg.this,
                                        Butt_kick_startExercise_leg.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Butt_kick_ready_togo_leg.super.onBackPressed();
                        Intent intent=new Intent(Butt_kick_ready_togo_leg.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
