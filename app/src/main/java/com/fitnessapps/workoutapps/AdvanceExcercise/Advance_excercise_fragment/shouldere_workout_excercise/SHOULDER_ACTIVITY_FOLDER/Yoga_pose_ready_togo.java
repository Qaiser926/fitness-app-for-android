...
public class Yoga_pose_ready_togo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yoga_pose_ready_togo);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Yoga_pose_ready_togo.this,
                                        Yoga_pose_startExerecise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Yoga_pose_ready_togo.super.onBackPressed();
                        Intent intent=new Intent(Yoga_pose_ready_togo.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
