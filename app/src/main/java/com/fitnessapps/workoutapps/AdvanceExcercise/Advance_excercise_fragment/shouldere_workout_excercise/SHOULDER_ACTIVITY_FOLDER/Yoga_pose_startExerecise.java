...
public class Yoga_pose_startExerecise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yoga_pose_start_exerecise);
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Yoga_pose_startExerecise.this,
                        Warm_upguy_startExercise.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Yoga_pose_startExerecise.super.onBackPressed();
                        Intent intent=new Intent(Yoga_pose_startExerecise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
