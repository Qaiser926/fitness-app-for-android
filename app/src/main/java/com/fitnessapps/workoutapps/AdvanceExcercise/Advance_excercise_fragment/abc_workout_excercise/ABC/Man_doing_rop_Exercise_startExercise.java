...
public class Man_doing_rop_Exercise_startExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_man_doing_rop_exercise_start_exercise);
...
// Request an ad
    ...
    private void PreviousTextView() {
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Man_doing_rop_Exercise_startExercise.this,
                        Jumping_jack_startExercise.class);
    ...
    private void SkipTextview() {
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Man_doing_rop_Exercise_startExercise.this,
                        Man_doing_rop_Exercise_rest.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Man_doing_rop_Exercise_startExercise.super.onBackPressed();
                        Intent intent=new Intent(Man_doing_rop_Exercise_startExercise.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
