...
public class Chest_tap_pushup_readytogo_chest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chest_tap_pushup_readytogo_chest);
...
//                                 Will be called if times up of countdown timer
                                ...
                                Intent intent=new Intent(Chest_tap_pushup_readytogo_chest.this,
                                        Chest_tap_pushup_startExercise_cheste.class);
        ...
        AlertDialog.Builder alertbox=new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Chest_tap_pushup_readytogo_chest.super.onBackPressed();
                        Intent intent=new Intent(Chest_tap_pushup_readytogo_chest.this,
                                MainActivity.class);
                        startActivity(intent);
                        finish();
